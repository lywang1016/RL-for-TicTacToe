...
def main():
    ...
    # game = Game(r_type='human', b_type='minmax', if_record=False, if_dataset=False)
    # game = Game(r_type='minmax', b_type='human', if_record=False, if_dataset=False)

    # game = Game(r_type='ai', b_type='minmax', if_record=False, if_dataset=False, ai_explore_rate=0)
    game = Game(r_type='minmax', b_type='ai', if_record=False, if_dataset=False, ai_explore_rate=0)
